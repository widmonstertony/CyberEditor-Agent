...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "gpu_probe_failed": "检测失败 · 请重新检测",
        "pytorch_probe_failed": "PyTorch 检测失败",
        ...
        "ollama_model": "全片视觉审片（2fps + 短动作最高4fps）", "director_model": "全局文字导演（视觉模型卸载后）", "ollama_context": "上下文长度",
        ...
        "ai_working": "AI 正在推理 · {activity} · 已用时 {elapsed} · 请求 {attempt}/{total}",
        "ai_activity_director_generation": "导演生成",
        "ai_activity_director_treatment": "导演阐述与叙事弧线",
        "ai_activity_visual_review": "完整画面审片",
        "ai_activity_picture_assembly": "全局镜头编排",
        "ai_activity_picture_critique": "总剪辑师叙事复审",
        "ai_activity_picture_recut": "质量门退回重剪",
        "ai_activity_narrative_contract": "逐事件证据契约",
        "ai_activity_blind_viewer_review": "陌生观众故事板盲审",
        "ai_activity_rough_cut_visual_review": "逐段观看低清成片",
        "ai_activity_rough_cut_blind_review": "低清成片陌生观众盲审",
        "ai_activity_music_spotting": "最终音乐设计",
    ...
    "en": {
        ...
        "gpu_probe_failed": "Probe failed · recheck",
        "pytorch_probe_failed": "PyTorch probe failed",
        ...
        "ollama_model": "Whole-footage vision review (2 fps + short actions up to 4 fps)", "director_model": "Global text director (after vision unload)", "ollama_context": "Context length",
        ...
        "ai_working": "AI reasoning · {activity} · elapsed {elapsed} · request {attempt}/{total}",
        "ai_activity_director_generation": "director generation",
        "ai_activity_director_treatment": "treatment and story arc",
        "ai_activity_visual_review": "full visual review",
        "ai_activity_picture_assembly": "global picture assembly",
        "ai_activity_picture_critique": "supervising-editor story review",
        "ai_activity_picture_recut": "quality-gate picture recut",
        "ai_activity_narrative_contract": "event-by-event evidence contract",
        "ai_activity_blind_viewer_review": "blind storyboard viewer test",
        "ai_activity_rough_cut_visual_review": "watching rendered rough cut",
        "ai_activity_rough_cut_blind_review": "rendered rough-cut blind review",
        "ai_activity_music_spotting": "final music spotting",
