...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "resolve_studio_auto_start": "Studio 已安装 · 执行时自动启动",
        "resolve_free_studio_required": "免费版 · 外部自动化需要 Studio",
        "resolve_edition_unknown": "已安装 · 版本待连接确认",
        ...
        "creative_brief": "想表达的主题（留空由 AI 发现）",
    ...
    "en": {
        ...
        "resolve_studio_auto_start": "Studio installed · auto-starts when needed",
        "resolve_free_studio_required": "Free edition · Studio required for external automation",
        "resolve_edition_unknown": "Installed · edition checked on connection",
        ...
        "creative_brief": "Theme to express (blank = AI discovers it)",
