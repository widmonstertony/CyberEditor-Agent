...
function collect() {
  ...
  return {
    ...
    whisper_device: "auto", sample_interval: Number(state.config.sample_interval || 0.5),
    max_keyframes: Number(state.config.max_keyframes || 14400),
    ollama_model: $("#ollamaModel").value, director_model: $("#directorModel").value,
